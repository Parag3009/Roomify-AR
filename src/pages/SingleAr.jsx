...
function SingleAr() {
  ...
  console.log("Type of a:", typeof a1);
  console.log("Type of b:", typeof b1);
  console.log("Value of a:", a1);
  console.log("Value of b:", b1);
  console.log(Identity);
    ...
    <div className="App">
      <div id="content">
        <nav className={`navbar ${menuOpen ? 'open' : ''}`}>
          ...
          {Identity?.map((item, itemIndex) => (
            <li key={itemIndex}><a className="ar-object" id={item} href="#">model number dekh ke daal :{item}</a></li>
          ))}
          <li><a className="ar-object" id="2" href="#">munna bhai </a></li>
          <li><a className="ar-object" id="3" href="#">munna bhai 2</a></li>
        </nav>
